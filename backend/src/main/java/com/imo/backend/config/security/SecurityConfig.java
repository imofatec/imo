  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    return http
        ...
        .authorizeHttpRequests(auth -> auth
            .requestMatchers(HttpMethod.PUT, "/api/user/upload/profile-picture")
            .authenticated()
            .requestMatchers(HttpMethod.PUT, "/api/user/update").authenticated()
            .requestMatchers(HttpMethod.PUT, "/api/user/update-progress/{courseId}")
            .authenticated()
            ...
            .requestMatchers(HttpMethod.GET, "/api/user/get-certificate/{courseId}")
            .authenticated()
            .requestMatchers(HttpMethod.GET, "/api/user/courses-progress").authenticated()
            .requestMatchers(HttpMethod.GET, "/api/user/course-progress/{courseId}")
            .authenticated()
