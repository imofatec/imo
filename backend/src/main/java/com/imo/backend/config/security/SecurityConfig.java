  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    return http
        ...
        .authorizeHttpRequests(auth -> auth
            .requestMatchers(HttpMethod.PUT, "/api/user/profile-picture")
            .authenticated()
            .requestMatchers(HttpMethod.PUT, "/api/user").authenticated()
            .requestMatchers(HttpMethod.PUT, "/api/user/progress/{courseId}")
            .authenticated()
            ...
            .requestMatchers(HttpMethod.GET, "/api/user/course/certificate/{courseId}")
            .authenticated()
