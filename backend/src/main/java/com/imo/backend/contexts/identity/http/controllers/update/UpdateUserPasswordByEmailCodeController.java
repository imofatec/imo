...
public class UpdateUserPasswordByEmailCodeController extends UserController {
  ...
  public UpdateUserPasswordByEmailCodeController(
      UpdatePasswordByEmailCodeService updatePasswordByEmailCodeService) {
  ...
  public ResponseEntity<UserDTO> handle(
      ...
      @Valid @RequestBody UpdatePasswordInput dto) {
    MongoDB.validateObjectId(userId);

    var updatedUser =
        this.updatePasswordByEmailCodeService.execute(emailCode, userId, dto.getPassword());
