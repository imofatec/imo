...
@RestController
public class GetAllCourseOverviewsWithPaginationController extends CourseControllerPagination {
    ...
    @Operation(summary = "Get all course overviews with pagination")
