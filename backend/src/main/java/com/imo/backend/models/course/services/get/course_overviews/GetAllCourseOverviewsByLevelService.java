...
@Service
public class GetAllCourseOverviewsByLevelService implements GetManyByToListService<CourseOverview> {
    private final CourseRepository courseRepository;

    public GetAllCourseOverviewsByLevelService(CourseRepository courseRepository) {
        this.courseRepository = courseRepository;
    }

    @Override
    public List<CourseOverview> execute(String slug) {
        return courseRepository.findAllBySlugLevel(slug).stream()
