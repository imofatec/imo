...
export default function SocialProfileSidebar({
  ...
  return (
    <aside className="h-full">
      <div className="flex h-full flex-col items-center py-4 text-center xl:items-start xl:text-left">
        ...
        <div className="mt-5 flex w-full flex-wrap justify-center gap-2 xl:justify-start">
          {categories.length ? (
