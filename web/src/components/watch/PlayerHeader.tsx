  ...
  return (
    <article className="overflow-hidden rounded-2xl border border-white/10 bg-[#14082f]/90 shadow-sm">
      ...
      <div className="min-w-0 space-y-3 p-5">
        ...
        <h2 className="text-xl font-semibold wrap-break-word text-white">{lesson.title}</h2>
        <p className="text-sm leading-7 wrap-break-word text-white/80">{lesson.description}</p>
      </div>
    </article>
  )
}
