      ...
      <div className="max-w-full min-h-screen">
        ...
        {loading || authLoading ? (
          ...
          <div className="flex flex-row">
            <div
              className={`flex flex-col p-8 transition-all duration-300 ease-in-out ${showLessons ? 'w-3/4' : 'w-full'}`}
            >
              <iframe
                loading="lazy"
                width="w-full"
              ...
              {currentLesson && (
                <CommentForm
                  ...
                  onCommentSubmit={refetchComments}
                />
              )}
              <div>
                      ...
                      <div>
                        {commentTree.map((comentario) => (
                          <LessonComment
                            key={comentario.id}
                            profilePic={
                              images[comentario.userId] || thumbLesson
                            }
            ...
            <div
              className={`relative transition-all duration-300 ease-in-out ${showLessons ? 'w-1/4' : 'w-12'}`}
            >
              <button
