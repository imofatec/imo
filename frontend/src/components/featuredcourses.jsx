...
export default function FeatureCourses({ title = "Default", text = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo temporibus eaque tempore neque dolores fuga quo debitis, fugiat repudiandae illum, similique magnam ea, rem sit explicabo optio? Corrupti, ad sit?",src = DefaultImage, order = ["image", "text", "list"] }) {
            ...
            case "text":
                return (
                    <div className="flex flex-col gap-4 md:gap-8 text-center md:text-left">
                        ...
                        <h1 className="text-custom-light-blue text-4xl md:text-5xl">{title}</h1>
                    ...
                    <div>
                        <ul className="text-lg md:text-xl space-y-16">
                            <li className="flex items-center space-x-4">
                                <div className="w-4 h-2.5 bg-custom-light-blue rounded-sm"></div>
